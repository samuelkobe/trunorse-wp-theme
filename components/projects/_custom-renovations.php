<?php if ( have_rows( 'custom_renovations' ) ) : ?>
<div class="w-full lg:pl-32 xl:pl-64 overflow-hidden">
  <h2 class="text-3xl xl:text-4xl text-tertiary font-bold leading-normal px-8 pt-16 lg:pt-32 mb-4">Custom Renovations</h2>
  <div class="bg-primary h-1 w-12 mx-8 mb-2"></div>
  <div class="swiper-container swiper-custom-renovations relative pr-16 pb-12 overflow-visible">
      <div class="swiper-wrapper m-8">
      	<?php while ( have_rows( 'custom_renovations' ) ) : the_row(); ?>
